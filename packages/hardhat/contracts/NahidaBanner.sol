...
//TODO: update chainlink vrf
//TODO: rename by banners
...
contract WishNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    function getHardPityCharacter(
        uint256 moddedRng2
    ) public pure returns (Characters) {
        uint256 indexNumber;
    ...
    function getSoftPityCharacter(
        uint256 moddedRng1,
        uint256 moddedRng2
    ) public view returns (Characters) {
        uint256 indexNumber;
        uint256[7] memory chanceArrayFourStars = get4StarChanceArray();
        uint256[6] memory chanceArrayFiveStars = get5StarChanceArray();
